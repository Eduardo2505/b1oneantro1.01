 ...
 * @author Eduardopc
 */
public class EliminarAdicionController extends HttpServlet {

    ComandaDaoImpl daocan = new ComandaDaoImpl();
    Comanda c = new Comanda();
    EmailEnv email = new EmailEnv();
    Producto provm = new Producto();
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idAdicion = request.getParameter("idAdicion");
        ...
        try {
            ...
            if (!c.getImpreso().equals("Impreso")) {
                AdicionalesDaoImpl dao = new AdicionalesDaoImpl();
                dao.eliminar(Integer.parseInt(idAdicion));
