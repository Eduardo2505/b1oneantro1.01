 ...
 * @author Eduardo
 */
public class BuscarProductoCategoriaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            res = dao.getFiltro(tipoEvento,"", idCategoria);
            //  out.println("entro");
            ...
            Logger.getLogger(BuscarProductoCategoriaController.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
