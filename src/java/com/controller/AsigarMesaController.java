 ...
 * @author Eduardo
 */
public class AsigarMesaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           // System.out.println(idEpleado);
            ...
            if (op.equals("asigar")) {
                //System.out.println("entroo actualizar");

                Zona z = new Zona();
                z.setIdzona(idZona);
                dao.actulizar(idMesa, z, "mesa");

            } else {
                Empleado e = new Empleado();
                e.setIdEmpleado(idEpleado);
                Mesas m = new Mesas();
                m = dao.bucarPormpleado(e);
                System.out.println(m.getIdMesa());
                dao.actulizartipo(m.getIdMesa(), "mesa");
                dao.actulizartipo(idMesa, "PP");
            }
