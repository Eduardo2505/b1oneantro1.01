 ...
 * @author Eduardo
 */
public class adicionalesregrescos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println(clase + "---> " + valor + "<br>");
            out.println(idclase + "---> " + valorx + "<br>");

            out.println(combinar + "<br>");

            if (va.equals("agregar")) {
            ...
            List res = daoaa.getAdicionales(idventa);
            Iterator itr = res.iterator();
            int verMesesa = 0;
            while (itr.hasNext()) {
                Adicionalesbean vc = (Adicionalesbean) itr.next();

                out.println("<tr><td>" + vc.getCantidad() + "</td><td>" + vc.getProducto() + "</td></tr>");
