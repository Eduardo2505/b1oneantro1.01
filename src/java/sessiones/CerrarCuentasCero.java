 ...
 * @author Eduardo
 */
public class CerrarCuentasCero extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idMesa = request.getParameter("idMesa").trim();
        ...
        try {
            ...
            dao.cerrar(idMesa,"Cerrado", horaActu,"-");
            daom.actulizar(mesa, "Activo");
        } finally {            
            out.close();
        }
    }
