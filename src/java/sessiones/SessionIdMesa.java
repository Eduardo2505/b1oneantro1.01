 ...
 * @author Eduardopc
 */
public class SessionIdMesa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //slee
           /* out.println(idMesa + "<br>");
             out.println(idComanda + "<br>");
             out.println(tipo);*/
            ...
            if (idComanda.equals("VER")) {
                ...
                // co = dao.bucarPorId(idComanda);
                out.println(contar+"<br>");
                gralComanda = idMesa.substring(0, 3) + "C" + d.getIdaltadia() + contar;
                ...
                sesion.setAttribute("idMesa", idMesa);
                out.println(idDia + " " + idMesa+"<br>");
                out.println(gralComanda);
                response.sendRedirect("Comanda_venta.jsp");
            ...
            Logger.getLogger(SessionIdMesa.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
