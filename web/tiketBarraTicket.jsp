...
//out.println(d);
                ...
                if (op.equals("excel")) {
                    ...
                    response.setHeader("Content-Disposition", "attachment;filename=\"BarraTicket" + d.getTipoEvento() + "" + dia + ".xls\"");
                } else {
    ...
    <body>
        ...
        <div id="muestra">
            ...
            <div>
                ...
                <label><H4>TOTAL(BARRA 1 + BARRA 2) </h4></label>
                ...
                <%
                    try {
                        ...
                        while (itr.hasNext()) {
                            ...
                            ver = con.verificarCategria(c.getIdCategoria());
                            if (ver != 0) {
                %>
                <table class="table">
                    <tr><th colspan="2"><h4><% out.println(c.getIdCategoria().toUpperCase());%></h4></th></tr>
                <tr><th>Ticket</th><th>Producto</th><th style='text-align:center'>Cantidad</th></tr>
                            <%
                                ...
                                sSQl = "select mv.idMesa_venta,p.nombre,count(vc.idVenta_Comandacol),(p.precio) from empleado em, producto p,venta_comanda vc,comanda c,mesa_venta mv where vc.idComanda=c.idComanda and p.idProducto=vc.idProducto and c.idaltadia=" + idDia + " and c.estado='Activo' and em.idEmpleado=mv.idEmpleado and mv.idMesa_venta=c.idMesa_venta  and mv.estado!='Cancelado' and p.idCategoria='" + c.getIdCategoria() + "' group by vc.idProducto,mv.idMesa_venta";
...
out.println("<tr><td>" + rs.getString(1).toUpperCase() + "</td><td>" + rs.getString(2).toUpperCase() + "</td><td>" + rs.getString(3) + "</td></tr>");
                ...
                <table >
                    ...
                    <tr><th>Ticket</th><th>Producto</th><th style='text-align:center' >Cantidad</th></tr>
                            <%
                                ...
                                sSQl = "select mv.idMesa_venta,p.nombre,count(vc.idVenta_Comandacol),vc.Observaciones from empleado em, producto p,venta_comanda vc,comanda c,mesa_venta mv where vc.idComanda=c.idComanda and p.idProducto=vc.idProducto and c.idaltadia=" + idDia + " and c.estado='Activo' and em.idEmpleado=mv.idEmpleado and em.idBarra='Barra 1' and mv.idMesa_venta=c.idMesa_venta and mv.estado!='Cancelado' group by vc.idProducto,mv.idMesa_venta";
                                // sSQl = "select p.nombre,count(vc.idVenta_Comandacol),vc.Observaciones from Empleado em, Producto p,Venta_Comanda vc,Comanda c,Mesa_venta mv where vc.idComanda=c.idComanda and p.idProducto=vc.idProducto and c.idaltadia=" + idDia + " and c.estado='Activo' and em.idEmpleado=mv.idEmpleado and em.idBarra='Barra 1'and mv.idMesa_venta=c.idMesa_venta group by vc.idProducto";
                                st = cn.prepareStatement(sSQl);
                                rs = st.executeQuery();
                ...
                <table>
                    <tr><th>Ticket</th><th>Producto</th><th>Cantidad</th></tr>
                            <%
