...
//style="display:none"
        ...
        <script type="text/javascript">
            function imprSelec(muestra)
            {
                ...
                ventimp.print();
                ventimp.close();
                jConfirm("Desea 'CONTINUAR' con la captura?", "Impresion Correcta", function(r) {
                    if (r) {
    ...
    <body onload="javascript:imprSelec('muestra')">
        ...
        <div id="muestra" style="display: none">
            <input type="hidden" id="idmesass" value="<% out.println(idMesa);%>">
            <table >
                <tr><td colspan="4" style=" text-align:center"><b><BR>PEDIDO<BR><hr></td></tr>
                            <tr><td colspan="4" style=" text-align:center"><h2>COPIA</h2></td></tr>
                            <tr><td colspan="4" style=" text-align:center"><h1>NO ES VALIDIO PARA BARRA</h1></td></tr>
                            <tr><td colspan="4">
                                    <table>
